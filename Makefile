...
define from-wks-template
	...
	@echo ""
	@echo "========================================"
	@echo "Building wk$(2) from config/key_chords.wks"
	@echo "Performing three-stage build..."
	@echo "========================================"
	@echo ""
	@echo "Stage 1: Building wk with bootstrap key chords..."
	@cp $(CONF_DIR)/key_chords_bootstrap.h $(CONF_DIR)/key_chords.h
	@$(MAKE) $(1) || exit 1
	@echo ""
	@echo "Stage 2: Transpiling key_chords.wks..."
	@./$(NAME) --transpile $(CONF_DIR)/key_chords.wks > $(CONF_DIR)/key_chords.h || { \
		echo ""; \
	...
	@echo ""
	@echo "Stage 3: Rebuilding wk with custom key chords..."
	@$(MAKE) $(1) || exit 1
	@echo ""
	@echo "========================================"
	@echo "Build complete$(2) with custom key chords!"
	@echo "========================================"
endef
...
clean:
	...
	rm -f $(MAN_FILES)
	rm -f $(WAY_FILES)
	rm -f $(CONF_DIR)/key_chords.h  # Remove generated/transpiled key chords (preserves key_chords.def.h)

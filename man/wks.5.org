...
** EXAMPLE - CHORD ARRAYS AND INTERPOLATION
...
** EXAMPLE - CHORD ARRAYS AND CHORD EXPRESSIONS
...
** EXAMPLE - HOOKS AND FLAGS IN CHORDS
...
** EXAMPLE - HOOKS AND FLAGS IN PREFIXES
...
For a more formal understanding, see *INHERITENCE* below.

** EXAMPLE - THE INCLUDE PREPROCESSOR MACRO
...
See *INHERITENCE* for an explanation of how /hooks/ work
...
See *INHERITENCE* for an explanation of how /flags/ work
when given to a /prefix/.

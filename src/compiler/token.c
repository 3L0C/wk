...
static const TokenTable tokenTable[TOKEN_LAST] = {
    ...
    [TOKEN_FOREGROUND_GOTO_COLOR]      = "TOKEN_FOREGROUND_GOTO_COLOR",
    [TOKEN_FOREGROUND_HEADER_COLOR]    = "TOKEN_FOREGROUND_HEADER_COLOR",
    [TOKEN_BACKGROUND_COLOR]           = "TOKEN_BACKGROUND_COLOR",
    [TOKEN_BACKGROUND_HEADER_COLOR]    = "TOKEN_BACKGROUND_HEADER_COLOR",
    ...
    [TOKEN_ALIGN_LEFT]   = "TOKEN_ALIGN_LEFT",
    [TOKEN_ALIGN_CENTER] = "TOKEN_ALIGN_CENTER",
    [TOKEN_ALIGN_RIGHT]  = "TOKEN_ALIGN_RIGHT",

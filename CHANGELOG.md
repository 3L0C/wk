...
- Generated `config.h` now defines `PROPERTY_INT`. Config headers
  generated by older `wk` versions must be regenerated with
  `make from-wks`, or manually updated; see
